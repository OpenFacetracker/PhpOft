...
#	name of the library file (phpoft.so) and the name of the config file (phpoft.ini)
...
OFT_LIB_VERSION = 3
OFT_LIB_PATH = ../ftLib3/openfacetracker_lin_lib-2.4.1.a


COMPILER_FLAGS		=	-Wall -c -O2 -std=c++11 -fPIC -I ../ftLib3/Header  -o
LINKER_FLAGS		=	-shared
LINKER_DEPENDENCIES	=	-lphpcpp ${OFT_LIB_PATH}
